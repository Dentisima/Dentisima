...
require(dirname(__FILE__) . '/class.writeexcel_workbook.inc.php');
require(dirname(__FILE__) . '/class.ole_pps_root.php');
require(dirname(__FILE__) . '/class.ole_pps_file.php');
