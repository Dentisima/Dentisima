...
require(dirname(__FILE__) . '/class.writeexcel_biffwriter.inc.php');
require(dirname(__FILE__) . '/class.writeexcel_format.inc.php');
require(dirname(__FILE__) . '/class.writeexcel_formula.inc.php');
require(dirname(__FILE__) . '/class.writeexcel_olewriter.inc.php');
