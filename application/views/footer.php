    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">Nueva Cita</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <form action="calendar.html" id="mainFormCalendar" method="post" name="mainFormCalendar">
                    ...
                    <div class="d-flex mg-t-15 mg-lg-t-30">
                        <button class="btn ripple btn-main-primary pd-x-25 mg-r-5" >Save</button> <a class="btn ripple btn-light" data-dismiss="modal" href="">Discard</a>
                    </div>
                </form>
            </div>
        </div>
...
<!-- End Modal -->
<div class="modal fade none-border" id="modal-generico">
    <div class="modal-dialog">
        <div class="modal-content" id="div-modal-generico"></div>
    </div>
</div>

<div class="modal fade none-border" id="modal-generico-busqueda">
    <div class="modal-dialog modal-90">
        <div class="modal-content" id="div-modal-generico-busqueda">

            <div class="modal-header">
                <h4 class="modal-title mt-0"><strong>BUSCAR PACIENTE</strong></h4>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="main-content-body-profile mb-3">
                            <nav class="nav main-nav-line">
                                <a class="nav-link active" data-toggle="tab" href="#tab1">Pacientes</a>
                                <a class="nav-link " data-toggle="tab" href="#tab2">Prospectos</a>
                                <a class="nav-link" data-toggle="tab" href="#tab3">Reportes</a> 
                            </nav>
                        </div>                          

                        <input class="form-control form-white" placeholder="" type="text" id="_buscadorpaciente"/>
                        <br><br>
                        <button class="btn ripple btn-success btn-rounded btn-block" type="button"
...
<div class="modal fade none-border" id="modal-generico_2">
    <div class="modal-dialog modal-90">
        <div class="modal-content" id="div-modal-generico_2">
